...
var Plugin = function Plugin(_ref) {
  ...
  var handleFiles = function handleFiles(files) {
    ...
    if (files) {
      ...
      axios.post("http://localhost:8099/upload", fd, config).then(function (response) {
        // handle success
        //this.overlayOff();
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      null,
      React.createElement('input', { type: 'file', id: 'input', onChange: function onChange(e) {
...
if (typeof window !== 'undefined') {
  ...
  window.botpress['botpress-webchat-plugin-file-uploader'] = { Plugin: Plugin, Entry: Entry };
}
